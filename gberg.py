...
class gberg_comb:
    ...
    def __init__(self, nside, radius, dil=1):
        ...
        self.tri_ind = [(0, n, (n + 2 if n < 10 else 2)) for n in range(2, 12, 2)] + [(1, n, (n + 2 if n < 11 else 3))
                                                                                      for n in range(3, 12, 2)] + [(n, (n + 1 if n < 11 else n + 1 - 10),
...
hp.projscatter(180, 90, c='y', lonlat=True)
plt.show()
